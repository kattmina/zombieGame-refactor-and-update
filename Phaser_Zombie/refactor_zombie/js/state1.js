...
zombieWorld.state1.prototype = {
    ...
    preload: function () {
        ...
        this.load.image('ground', 'assets/images/cementery/ground.png');
        this.load.image('platform', 'assets/images/cementery/platform.png');
        this.load.image('platform2', 'assets/images/cementery/platform2.png');

        // background and background objects
        this.load.image('BG', 'assets/images/cementery/BG.png');

        this.game.load.image('tree', 'assets/images/cementery/bg_objects/Tree.png');
        this.game.load.image('tree2', 'assets/images/cementery/bg_objects/Tree2.png');
        this.game.load.image('TombStone1', 'assets/images/cementery/bg_objects/TombStone1.png');
        this.game.load.image('TombStone2', 'assets/images/cementery/bg_objects/TombStone2.png');
        this.game.load.image('skel', 'assets/images/cementery/bg_objects/Skeleton2.png');
        this.game.load.image('grass1', 'assets/images/cementery/bg_objects/Grass.png');
        this.game.load.image('grass2', 'assets/images/cementery/bg_objects/grassTiles.png');
        this.game.load.image('stone', 'assets/images/cementery/bg_objects/rockTiles.png');
        this.game.load.image('bush', 'assets/images/cementery/bg_objects/Bush2.png');
        this.game.load.image('bush2', 'assets/images/cementery/bg_objects/Bush1.png');
        ...
        this.load.image('sawTurn', 'assets/images/cementery/bg_objects/TombStone1.png');

        this.load.image('spike', 'assets/images/obstacles_for_zombie/pinkspikes.png', 100, 100);
    ...
    create: function () {
        ...
        // background objects
        this.bgimage = this.add.sprite(630, 363, 'tree2');
        this.bgimage = this.add.sprite(1000, 170, 'tree');

        this.bgimage = this.add.sprite(890, 550, 'skel');

        this.bgimage = this.add.sprite(1050, 350, 'TombStone1');
        this.bgimage = this.add.sprite(1100, 330, 'TombStone2');
        this.bgimage = this.add.sprite(100, 585, 'stone');
        this.bgimage = this.add.sprite(730, 610, 'grass1');

        this.bgimage = this.add.sprite(280, 280, 'grass2');
        this.bgimage = this.add.sprite(300, 290, 'grass1');

        this.bgimage = this.add.sprite(425, 752, 'bush');
        this.bgimage = this.add.sprite(495, 712, 'bush2');
        this.bgimage = this.add.sprite(300, 420, 'bush2');
        this.bgimage = this.add.sprite(490, 752, 'grass1');
        this.bgimage = this.add.sprite(550, 752, 'grass1');
        this.bgimage = this.add.sprite(550, 725, 'TombStone2');
        this.bgimage = this.add.sprite(1000, 523, 'TombStone2');
        ...
        //parse the file
        this.level1Data = JSON.parse(this.game.cache.getText('level1'));

        this.platforms = this.add.group();
        this.platforms.enableBody = true;

        this.level1Data.platform1.forEach(function (element) {
            this.platforms.create(element.x, element.y, 'platform');
        }, this);

        this.level1Data.platform2.forEach(function (element) {
        ...
        var crystal;
        this.level1Data.crystalData.forEach(function (element) {
        ...
        var spike;
        this.level1Data.obstacleData.forEach(function (element) {
        ...
        //create zombie
        this.zombie = this.add.sprite(this.level1Data.zombieStart.x, this.level1Data.zombieStart.y, 'zombie', 3);
        ...
        this.createSaw();
        this.sawCreator = this.game.time.events.loop(Phaser.Timer.SECOND * this.level1Data.sawFrequency, this.createSaw, this);
    ...
    update: function () {
        ...
        //this.game.physics.arcade.collide(this.zombie, this.crystal, this.win);
    ...
    createSaw: function () {
        ...
        saw.body.velocity.x = this.level1Data.sawSpeed;
    },
